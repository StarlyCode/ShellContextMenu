...
namespace ShellContextMenu
{
    ...
    public class ShellContextMenu : NativeWindow
    {
        ...
        protected override void WndProc(ref Message m)
        {
                 ...
                 m.Msg == (int)WM.DRAWITEM))
            {
                if (_oContextMenu2.HandleMenuMsg(
                    (uint)(ulong)m.Msg, m.WParam, m.LParam) == S_OK)
                    return;
            }
                ...
                m.Msg == (int)WM.MENUCHAR)
            {
                if (_oContextMenu3.HandleMenuMsg2(
                    (uint)(ulong)m.Msg, m.WParam, m.LParam, IntPtr.Zero) == S_OK)
                    return;
            }
        ...
        private void InvokeContextMenuDefault(FileInfo[] arrFI)
        {
            ...
            try
            {
                ...
                uint nDefaultCmd = (uint)(ulong)GetMenuDefaultItem(pMenu, false, 0);
    ...
    public class LocalWindowsHook
    {
        ...
        public void Install()
        {
            ...
            //To get a stable identifier for a managed thread, use the ManagedThreadId property on Thread.  http://go.microsoft.com/fwlink/?linkid=14202'
        }
        // ************************************************************************
    ...
    internal static class ShellHelper
    {
        ...
        {
            if (((uint)(ulong)ptr & 0x80000000) == 0x80000000)
